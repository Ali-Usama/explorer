    ...
    <div>
        <div class="tabs tabs-boxed bg-transparent mb-4">
            ...
            <RouterLink class="tab text-gray-400 uppercase" 
                ...
                >Search</RouterLink>
            <a class="tab text-gray-400 uppercase tab-active !text-white">Transaction</a>
        </div>

        <div v-if="tx.tx_response" class="bg-base-100 dark:bg-[#211f1f] px-4 pt-3 pb-4 rounded shadow mb-4">
        ...
        <div v-if="tx.tx_response" class="bg-base-100 dark:bg-[#211f1f] px-4 pt-3 pb-4 rounded shadow">
